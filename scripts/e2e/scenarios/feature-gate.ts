...
A tiny command-line greeting app used to exercise the BuildFlow workflow.
...
async function run(t: Runner) {
  ...
  t.write("buildflow/context/project-overview.md", PROJECT_OVERVIEW);
  ...
  const currentFeature = t.read("buildflow/context/current-feature.md") || "";
