---
name: tests
description: Add or normalize stack-native unit testing, reuse or install the appropriate runner, add one example test, document commands, and verify the setup. Use for /tests, adding unit tests, configuring a test runner, or enabling the BuildFlow logic-test gate.
---
...
Testing is optional in the BuildFlow until the project declares a real test
...
6. Update `buildflow/context/coding-standards.md` only if the project needs a
