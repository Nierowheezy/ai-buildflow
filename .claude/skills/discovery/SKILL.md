...
- `buildflow/context/project-overview.md` only when the user is revisiting an
...
- This skill is always optional. Never make it a prerequisite for `/overview`,
  `/feature`, or any other BuildFlow command.
...
Follow `buildflow/context/ai-interaction.md`. During discovery, ask one focused
