...
- `latest`: use the most recent archive under `buildflow/history/features/`,
  `buildflow/history/fixes/`, or `buildflow/history/rollbacks/`
...
- latest files under `buildflow/history/features/`,
  `buildflow/history/fixes/`, and `buildflow/history/rollbacks/`, if the current
  feature is reset
...
`buildflow/context/ai-interaction.md`: concise, scannable markdown, with numbered
